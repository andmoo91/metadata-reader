...
output = "Filename,Channels,Z slices,Time frames,X size,Y size,X pixel size (microns),Y pixel size (microns),Z pixel size (microns),Acquisition Date,Microscope Type,Objective Used\n";
...
ElyraSIM = "Elyra SIM";
    ...
    output += list[i] + "," + sizeC + "," + sizeZ + "," + sizeT + "," + sizeX + "," + sizeY + "," + pixelSizeX + "," + pixelSizeY + "," + pixelSizeZ + "," +acquisitionDate+ "," + scopeID + "," + objectiveID + "\n";
