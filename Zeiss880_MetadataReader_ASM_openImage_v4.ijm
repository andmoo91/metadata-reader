...
Ext.getMetadataValue("Information|Image|ComponentBitCount #1", componentBitCount1);
Ext.getMetadataValue("Information|Document|CreationDate", creationDate);
Ext.getMetadataValue("Information|Document|CreationDate #1", creationDate1);
Ext.getMetadataValue("Information|Instrument|Microscope|System", microscopeSystem);
Ext.getMetadataValue("Information|Instrument|Microscope|System #1", microscopeSystem);
Ext.getMetadataValue("Information|Instrument|Objective|Manufacturer|Model", objectiveId);
Ext.getMetadataValue("Information|Instrument|Objective|Manufacturer|Model #1", objectiveId1);
...
Ext.getMetadataValue("Information|Image|S|Scene|Position|X #1", xPos1);
Ext.getMetadataValue("Information|Image|S|Scene|Position|Y", yPos);
Ext.getMetadataValue("Information|Image|S|Scene|Position|Y #1", yPos1);
Ext.getMetadataValue("Information|Image|S|Scene|Position|Z", zPos);
Ext.getMetadataValue("Information|Image|S|Scene|Position|Z #1", zPos1);
...
Ext.getMetadataValue("Experiment|AcquisitionBlock|AcquisitionModeSetup|AcquisitionMode #1", acquisitionMode1);
...
if (componentBitCount==0) componentBitCount = componentBitCount1;
if (creationDate==0) creationDate = creationDate1;
if (objectiveId==0) objectiveId = objectiveId1;
if (acquisitionMode==0) acquisitionMode = acquisitionMode1;
if (xPos==0) xPos = xPos1;
if (yPos==0) yPos = yPos1;
if (zPos==0) zPos = zPos1;
...
if (sizeC==1) {
    ...
    Ext.getMetadataValue("Information|Image|Channel|DetectionWavelength|Range", detectionWavelengthRanges);
    Ext.getMetadataValue("Experiment|AcquisitionBlock|MultiTrackSetup|TrackSetup|Detector|Color", color);
    Ext.getMetadataValue("Information|Instrument|Detector|Type #", detectorId);
    ...
    Ext.getMetadataValue("Experiment|AcquisitionBlock|MultiTrackSetup|TrackSetup|Attenuator|Laser", lightSourceId);
    ...
    Ext.getMetadataValue("Information|Image|Channel|LaserScanInfo|ScanningMode", scanningMode);
    Ext.getMetadataValue("Information|Image|Channel|LaserScanInfo|SampleRotation", sampleRotation);
    Ext.getMetadataValue("Information|Image|Channel|Gain", gain);
	Ext.getMetadataValue("Information|Processing|Airyscan|Channel|ParameterEstimationType", processingType);
	Ext.getMetadataValue("Information|Processing|Airyscan|Channel|SuperResolutionParameter", processingParameter);
	Ext.getMetadataValue("Experiment|AcquisitionBlock|MultiTrackSetup|TrackSetup|Detector|Filterset", filterSet);
	Ext.getMetadataValue("Information|Processing|Airyscan|Channel|ParameterEstimationType", autoProc);
	Ext.getMetadataValue("Information|Processing|Airyscan|Channel|DeconvolutionType", deconType);
}
else{
